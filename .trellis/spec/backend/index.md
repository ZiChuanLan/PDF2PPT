...
| [OCR Layout Block Contracts](./ocr-layout-block-contracts.md) | Dual-path OCR/image-overlay contract for image-like layout blocks and polygon-safe crop padding | Active |
